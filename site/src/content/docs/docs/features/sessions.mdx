...
- **Mobile touch-bar:** on the installed iOS PWA, a toolbar above the keyboard adds Esc, Tab, Ctrl, arrow keys, and Ctrl+C, plus **Paste** (reads the clipboard and sends it with bracketed-paste) and **Copy** (long-press then drag to select text, then tap Copy to copy the selection).
