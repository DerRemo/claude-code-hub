...
- **Terminal:** font size, scrollback lines, mouse mode (`TMUX_MOUSE`), copy-on-select, and (macOS) whether Option acts as Meta for readline word navigation or types layout characters (`@ | { } [ ] ~` on non-US keyboards) — off by default.
