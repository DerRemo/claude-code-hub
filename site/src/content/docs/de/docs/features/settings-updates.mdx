...
- **Terminal:** Schriftgröße, Scrollback-Zeilen, Mouse-Mode (`TMUX_MOUSE`), Copy-on-Select und (macOS) ob ⌥ als Meta für Readline-Wortnavigation dient oder Tastatur-Sonderzeichen tippt (`@ | { } [ ] ~` auf nicht-US-Layouts) — standardmäßig aus.
