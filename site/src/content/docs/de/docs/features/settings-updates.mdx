...
- **Terminal:** Schriftgröße, Scrollback-Zeilen, Mouse-Mode (`TMUX_MOUSE`), Copy-on-Select und macOS Option-als-Meta (standardmäßig aus, sodass Option Layout-Zeichen wie `@ | { }` tippt statt Meta-Kürzel zu senden).
