...
- **Copy/Paste in der iOS-PWA:** Da der tmux-Mouse-Mode die native Textauswahl blockiert und es kein Hardware-Cmd+C/V gibt, bietet die Touch-Bar eigene Paste- (liest die Zwischenablage beim Tippen) und Copy-Tasten (Long-Press, dann Ziehen zum Markieren, Loslassen zum Kopieren).
