...
- **Copy/Paste auf der iOS-PWA:** Die Touch-Tastaturleiste bringt Paste (liest die Zwischenablage in der Tap-Geste und fügt sie via Bracketed-Paste ein) und Copy (Long-Press, dann Ziehen zum Markieren — wird als Maus-Events an tmux weitergereicht, ein normaler Swipe scrollt weiterhin; beim Loslassen wird die Auswahl übernommen und beim nächsten Copy-Tap kopiert). Copy braucht das tmux-Drag, funktioniert also am Shell-Prompt; Vollbild-CLIs wie Claude Code oder Codex fangen die Maus selbst ab.
