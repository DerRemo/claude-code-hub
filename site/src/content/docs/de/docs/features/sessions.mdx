...
- **Copy/Paste auf iOS:** Die installierte iPhone-PWA hat kein Hardware-⌘C/⌘V, und der tmux-Mouse-Mode blockiert die native Textauswahl. Deshalb bietet die Touch-Bar über der Tastatur **Paste** (liest die Zwischenablage und fügt sie ins Terminal ein) und **Copy** (Long-Press, dann Ziehen zum Auswählen, danach Copy tippen, um die Auswahl aus tmux zu holen und zu kopieren).
