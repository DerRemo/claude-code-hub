...
- **Mobile Touch-Toolbar:** Auf der installierten iOS-PWA blendet eine Leiste über der Tastatur Esc, Tab, Ctrl, Pfeiltasten und Ctrl+C ein, dazu **Paste** (liest die Zwischenablage und sendet sie per Bracketed-Paste) und **Copy** (Long-Press, dann per Drag Text markieren, danach Copy tippen, um die Auswahl zu kopieren).
