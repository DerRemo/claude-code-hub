...
- **Copy/Paste auf der iOS-PWA:** Die Touch-Bar über der Tastatur bekommt Copy- und Paste-Tasten, da der tmux-Mouse-Mode die native Textauswahl blockiert und es kein Hardware-Cmd+C/V gibt. Paste liest die Zwischenablage beim Tippen; Long-Press und Ziehen wählt Text aus (ein normaler Swipe scrollt weiterhin), die Auswahl wird beim nächsten Copy-Tap kopiert.
