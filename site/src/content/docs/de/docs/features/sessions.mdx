...
- **Copy/Paste auf der installierten iPhone/iPad-PWA:** Die Touch-Bar des Terminals bekommt eigene **Copy**- und **Paste**-Tasten, da der tmux-Mouse-Mode native Textauswahl blockiert. Lange drücken und dann ziehen wählt Text aus (ein normaler Swipe scrollt weiterhin); **Copy** tippen holt die Auswahl aus dem tmux-Buffer, **Paste** tippen fügt die Zwischenablage per Bracketed-Paste ein.
