...
// Hub-Installation dieses Users läuft auf den 1M-Varianten von Opus 4.x/5 und
// Sonnet 4.6/5 — default 200k wäre bei >200k Context-Werten unlogisch (die
// Session-Karte zeigte sonst >100% Context). Claude Code defaultet seit
// v2.1.219 auf Opus 5 → hier gelistet. In Sync mit den ausgelieferten Modellen
// halten (vgl. pricing.js).
