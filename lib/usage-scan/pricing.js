...
const PRICING = new Map([
  ...
  // Claude 5 family shares the tier rates of its 4.x predecessor (Opus 5 ==
  // Opus 4.8, Sonnet 5 == Sonnet 4.6) — added so the newer CLIs, which now
  // default to Opus 5, don't fall through to the opus DEFAULT (which would
  // mis-price Sonnet 5 at opus rates).
  ['claude-opus-5',     { in: 15,   out: 75,  cached: 1.5  }],
