...
const PRICING = new Map([
  ...
  // Claude 5 family (2026): claude-opus-5 is Claude Code's new default model.
  // Priced on the same per-tier convention as the 4.x rows (opus/sonnet); fable-5
  // has no 4.x precedent → Anthropic list price ($10/$50 per 1M, cache = in*0.1).
